...
var initMap = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var maps, map, coordinates, centerCoordinates, myMap, myPlacemark;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return _vendor_ymaps__WEBPACK_IMPORTED_MODULE_0__["default"].load();
          case 2:
            maps = _context.sent;
            map = document.querySelector('#map');
            coordinates = map.dataset.coordinates.split(',');
            centerCoordinates = map.dataset.center.split(',');
            myMap = new maps.Map(map, {
              center: centerCoordinates,
              zoom: 16
            });
            myPlacemark = new maps.Placemark(coordinates, {
              hintContent: ''
            }, {
