...
/* harmony import */ var _modules_init_phone_mask__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/init-phone-mask */ "./js/modules/init-phone-mask.js");
/* harmony import */ var _modules_init_validation__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/init-validation */ "./js/modules/init-validation.js");
/* harmony import */ var _modules_init_mob_menu__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/init-mob-menu */ "./js/modules/init-mob-menu.js");
/* harmony import */ var _modules_init_map__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/init-map */ "./js/modules/init-map.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    Object(_modules_init_mob_menu__WEBPACK_IMPORTED_MODULE_3__["initMobMenu"])();
    Object(_modules_init_phone_mask__WEBPACK_IMPORTED_MODULE_1__["initPhoneMask"])();
    Object(_modules_init_validation__WEBPACK_IMPORTED_MODULE_2__["initValidation"])();
    Object(_modules_init_map__WEBPACK_IMPORTED_MODULE_5__["initMap"])();
  });
});
...
/* harmony import */ var _vendor_ymaps__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_vendor_ymaps__WEBPACK_IMPORTED_MODULE_0__);
...
var initMap = function initMap() {
  ...
  var coordinates = map.dataset.coordinates.split(',');
  var centerCoordinates = map.dataset.center.split(',');
  ymaps.ready(init);
  function init() {
...
/*!*************************************!*\
  !*** ./js/modules/init-mob-menu.js ***!
  \*************************************/
/*! exports provided: initMobMenu */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initMobMenu", function() { return initMobMenu; });
var initMobMenu = function initMobMenu() {
  var TABLET_WIDTH = 768;
  var header = document.querySelector('.header');
  var button = header.querySelector('.header__menu-button');
  var navLinks = header.querySelectorAll('.header__nav-item a');
  var isMenuOpen = true;
...
/* harmony import */ var _vendor_imask__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../vendor/imask */ "./js/vendor/imask.js");
/* harmony import */ var _vendor_imask__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_vendor_imask__WEBPACK_IMPORTED_MODULE_0__);
...
var initPhoneMask = function initPhoneMask() {
  ...
  telInputs.forEach(function (telInput) {
    _vendor_imask__WEBPACK_IMPORTED_MODULE_0___default()(telInput, maskOptions);
  });
};
...
/* harmony import */ var _utils_validation_rules_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/validation-rules.js */ "./js/utils/validation-rules.js");
...
var initValidation = function initValidation() {
  ...
  forms.forEach(function (form) {
    ...
    var checkInput = function checkInput(input) {
      var check = _utils_validation_rules_js__WEBPACK_IMPORTED_MODULE_0__["rules"][input.type];
...
var rules = {
  ...
  email: function email(value) {
    if (!value) {
      ...
      var result = mailRegEx.test(value);
      if (!result) {
...
(function (global, factory) {
  ...
  var fails$5 = function fails$5(exec) {
    try {
      return !!exec();
    } catch (error) {
      return true;
  ...
  var isObject$4 = function isObject$4(it) {
  ...
  var toPrimitive$2 = function toPrimitive$2(input, PREFERRED_STRING) {
  ...
  var getBuiltIn$2 = function getBuiltIn$2(namespace, method) {
...
(function ymapsInit(e) {
  ...
  "vectorVersionTimestamp": 1667039936618,
  "flags": [],
  "server": {
    "url": "https://api-maps.yandex.ru/2.1.79",
    "path": "build/release",
    "params": {
      "apikey": "13f11081-1160-4e14-80da-aceac3e29678",
      "mode": "release",
      "ns": "ymaps",
      "csp": null
    },
  ...
  "layers": {
    "map": {
      "version": "22.10.27-0-b220930144100",
      "scaled": true,
    ...
    "stv": {
      "version": "2022.10.28.19.51-1_22.10.28-0-12778"
    },
    "sta": {
      "version": "2022.10.28.19.51-1_22.10.28-0-12778"
    },
