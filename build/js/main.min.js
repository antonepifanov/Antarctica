...
var initMap = function initMap() {
  ...
  _vendor_ymaps__WEBPACK_IMPORTED_MODULE_0__["default"].load().then(function (maps) {
    var myMap = new maps.Map('map', {
      center: centerCoordinates,
      zoom: 16
    });
    var myPlacemark = new maps.Placemark(coordinates, {
      hintContent: ''
    }, {
...
var initMobMenu = function initMobMenu() {
  ...
  var isMenuOpen = true;
  var onMenuOverlayClick = function onMenuOverlayClick(evt) {
